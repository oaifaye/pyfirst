...
# 导入数据文件
df = pd.read_table('demo2_Iris.txt', sep=' ', names=
['col1', 'col2', 'col3', 'col4',  'label']) # 读取数据文件
...
['col1', 'col2', 'col3', 'col4']) # 将数据转换为数据框并命名列名
...
x_RandomUnderSampler_resampled = pd.DataFrame(x_RandomUnderSampler_resampled,columns=
['col1','col2','col3','col4']) # 将数据转换为数据框并命名列名
y_RandomUnderSampler_resampled = pd.DataFrame(y_RandomUnderSampler_resampled, columns=
...
x_EasyEnsemble_resampled_t = pd.DataFrame(x_EasyEnsemble_resampled[index_num],columns=
['col1','col2','col3','col4']) # 将数据转换为数据框并命名列名
